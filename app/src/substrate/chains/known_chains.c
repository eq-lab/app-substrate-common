...
#include "chains/assethub_polkadot/assethub_polkadot.h"
...
const uint8_t GenesisHash_AssetHub_Polkadot[32] = {104, 213, 111, 21, 248, 93, 49, 54, 151, 14, 193, 105, 70, 4, 11, 193, 117, 38, 84, 233, 6, 20, 127, 126, 67, 233, 213, 57, 215, 195, 222, 47};
const uint8_t GenesisHash_AssetHub_Kusama[32] = {72, 35, 158, 246, 7, 215, 146, 136, 116, 2, 122, 67, 166, 118, 137, 32, 151, 39, 223, 179, 211, 220, 94, 91, 3, 163, 155, 220, 46, 218, 119, 26};
...
bool _readKnownChainType(parser_tx_t *v) {
    if(!memcmp(v->genesisHash._ptr, GenesisHash_Polkadot, 32)){
    ...
    } else if(!memcmp(v->genesisHash._ptr, GenesisHash_AssetHub_Polkadot, 32)){
        v->knownChainType = KnownChainType_AssetHub_Polkadot;
        ...
        v->knownChainType = KnownChainType_Unknown;
        return false;
    }
    return true;
}
...
const char* _getMethod_chainName(known_chain_type_t knownChainType) {
    ...
    case KnownChainType_AssetHub_Polkadot:
        return STR_CH_AssetHub_Polkadot;

    case KnownChainType_AssetHub_Kusama:
        return STR_CH_AssetHub_Kusama;

    case KnownChainType_Equilibrium:
        return STR_CH_Equilibrium;

    case KnownChainType_Genshiro:
        return STR_CH_Genshiro;
        
    case KnownChainType_Acala:
        return STR_CH_Acala;
        
    case KnownChainType_Karura:
        return STR_CH_Karura;
        
    case KnownChainType_Bifrost_Polkadot:
        return STR_CH_Bifrost_Polkadot;
        
    case KnownChainType_Bifrost_Kusama:
        return STR_CH_Bifrost_Kusama;
        
    case KnownChainType_Nodle:
        return STR_CH_Nodle;
        
    case KnownChainType_Zeitgeist:
        return STR_CH_Zeitgeist;
        
    case KnownChainType_Astar:
        return STR_CH_Astar;

    case KnownChainType_Shiden:
        return STR_CH_Shiden;

    case KnownChainType_Mangata:
        return STR_CH_Mangata;

    case KnownChainType_Hydradx:
