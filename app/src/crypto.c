...
zxerr_t crypto_fillAddress(key_kind_e addressKind, uint8_t *buffer, uint16_t bufferLen, uint16_t *addrResponseLen) {
    ...
    // NOT FAILED:  Polkadot, Kusama, Parallel 
    // FAILED with ERROR 26625 == 0x6801: Acala, Bifrost, Genshiro, Karura
    ...
    // CHECK_ZXERR(zxerr_ledger_api_error)
    if (outLen == 0) {
        MEMZERO(buffer, bufferLen);
        return zxerr_unknown;
    }
...
354	        0x80000162	                DOT	    Polkadot    APPPATH = "44'/354'" --path "44'/434'"      https://github.com/LedgerHQ/app-polkadot/blob/develop/app/Makefile
434	        0x800001b2	                KSM	    Kusama      APPPATH = "44'/434'" --path "44'/354'"      https://github.com/LedgerHQ/app-kusama/blob/develop/app/Makefile
???         0x80000162                  PARA    Parallel    APPPATH = "44'/354'"                        https://github.com/LedgerHQ/app-parallel/blob/develop/app/Makefile

787	        0x80000313	                ACA	    Acala       APPPATH = "44'/787'" --path "44'/354'"      https://github.com/LedgerHQ/app-acala/blob/develop/app/Makefile
788	        0x80000314	                BNC	    Bifrost
                                        GENS    Genshiro    APPPATH = "44'/99999996'" --path "44'/354'" --path "44'/434'"
*/